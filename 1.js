...
const template = {'bannerType':'banner','verticalAlign':'bottom','horizontalAlign':'right','buttonColor':'#1C43B9','hoverColor':'#214698','textColor':'#fff','theme':'light','fontName':'Helvetica','toggleColor':'#1C43B9','bannerText':'We use three kinds of cookies on our websites: required, functional, and advertising. You can choose whether functional and advertising cookies apply. Click on the different cookie categories to find out more about each category and to change the default settings.','customizeDescription':'IDfy\'s website may request cookies to be set on your device. We use cookies to identify when you visit our sites, to understand your interactions, and to enhance and personalize your experience. Cookies also support social media features and tailor your engagement with IDfy, including delivering more relevant advertisements. You can review the different category headings to learn more and adjust your cookie preferences anytime. Please keep in mind that your choices may affect your experience on our IDfy sites and the quality of services we can provide. Blocking certain types of cookies might affect the functionality and service offerings made available to you.'}
const categorisedCookies = {'necessary':{'data':[{'platform':'IDfy','category':'Necessary','cookie_name':'_idfy_session','description':'Preserves user session state across page requests.','duration':'Session','data_controller':'IDfy','id':'b76163e7-5131-4872-9c8a-6b926b751f51'}],'description':'Essential cookies are crucial for the delivery of services, applications, or resources you request. They enable the website to function properly by managing actions such as loading visual elements, accessing resources, or user sign-ins and sign-outs. Essential cookies also ensure the service\'s security and efficiency by enabling features like authentication and load balancing.'},'functional':{'data':[{'id':'4204f375-a3e5-4b04-ae39-9adb71f3eb5d','platform':'DoubleClick/Google Marketing','category':'Functional','cookie_name':'test_cookie','domain':'doubleclick.net','description':'This cookie is set by DoubleClick (which is owned by Google) to determine if the website visitor\'s browser supports cookies.','duration':'1 year','data_controller':'Google','privacy_doc':'https://privacy.google.com/take-control.html','wildcard_match':'0'},{'id':'36b7ca9d-ebcd-4d0e-b81e-27d44303f834','platform':'Cloudflare','category':'Functional','cookie_name':'__cf_bm','domain':'','description':'Cloudflare\'s bot products identify and mitigate automated traffic to protect your site from bad bots. Cloudflare places the __cf_bm cookie on End User devices that access Customer sites that are protected by Bot Management or Bot Fight Mode. The __cf_bm cookie is necessary for the proper functioning of these bot solutions.','duration':'session','data_controller':'Cloudflare','privacy_doc':'https://www.cloudflare.com/privacypolicy/','wildcard_match':'0'},{'id':'f1fbdbbe-1326-4a0b-9a70-8d260c554936','platform':'Cloudflare','category':'Functional','cookie_name':'_cfuvid','domain':'','description':'The _cfuvid cookie is only set when a site uses this option in a Rate Limiting Rule, and is only used to allow the Cloudflare WAF to distinguish individual users who share the same IP address.','duration':'session','data_controller':'Cloudflare','privacy_doc':'https://www.cloudflare.com/privacypolicy/','wildcard_match':'0'},{'id':'d0a28cbf-c082-477b-99fe-b45d0ef7e440','platform':'Youtube','category':'Functional','cookie_name':'YSC','domain':'youtube.com (3rd party)','description':'Registers a unique ID to keep statistics of what videos from YouTube the user has seen.','duration':'Session','data_controller':'Google','privacy_doc':'https://privacy.google.com/take-control.html','wildcard_match':'0'},{'id':'46f0caca-7905-46ca-ae59-df689f8ef5fe','platform':'J2EE','category':'Functional','cookie_name':'JSESSIONID','domain':'','description':'JSESSIONID is a cookie generated by Servlet containers and used for session management in J2EE web applications for HTTP protocol. If a Web server is using a cookie for session management, it creates and sends JSESSIONID cookie to the client and then the client sends it back to the server in subsequent HTTP requests. JSESSIONID is a platform session cookie and is used by sites with JavaServer Pages (JSP). The cookie is used to maintain an anonymous user session by the server.','duration':'session','data_controller':'J2EE','privacy_doc':'','wildcard_match':'1'}],'description':'Set by us or third-party providers, functional cookies add extra features and enhance our website\'s functionality not directly necessary for the service you\'ve requested. They enable convenience features such as pre-filled text fields, live chat support, and optional forms, improving your browsing experience with services like single sign-on (SSO).'},'performance':{'data':[{'platform':'Google Analytics','category':'Performance','cookie_name':'_gat_UA-31536997-8','description':'Used to throttle the request rate - limiting the collection of data on high traffic sites.','duration':'1 minute','data_controller':'Google','id':'814c2599-6224-4bde-b1f4-92d1f310e3db'}],'description':'These cookies collect data on how visitors interact with our website, allowing us to measure and improve our site\'s and software\'s effectiveness. They help us track visits and traffic sources, optimizing our website\'s performance. Without these cookies, we lose the ability to monitor our site\'s engagement and enhance user experience.'},'analytics':{'data':[{'platform':'Google Analytics','category':'Analytics','cookie_name':'_ga_SCYRND3JQS','description':'Used to distinguish users by assigning a randomly generated number as a client identifier.','duration':'2 years','managed_by':'Google','data_controller':'Google LLC','id':'3c4fb681-5536-4322-8b74-02d371545481'},{'platform':'Google Analytics','category':'Analytics','cookie_name':'_ga_FLWE815XLG','description':'Used to distinguish users in Google Analytics.','duration':'2 years','data_controller':'Google','id':'29b0e1c2-f374-4fb7-bc06-67904f24b569'},{'id':'256c18e8-d881-11e9-8a34-2a2ae2dbcce4','platform':'Google Analytics','category':'Analytics','cookie_name':'_ga','domain':'google-analytics.com (3rd party) or','description':'ID used to identify users','duration':'2 years','data_controller':'Google','privacy_doc':'https://privacy.google.com/take-control.html','wildcard_match':'0'},{'platform':'Google Analytics','category':'Analytics','cookie_name':'_gat_gtag_UA_31536997_8','description':'Used to throttle request rate in Google Analytics. This cookie does not store any user information.','duration':'1 minute','data_controller':'Google LLC','id':'b8b0166b-7dc7-4ca9-a8bc-7995ae6e4770'},{'id':'256c1ae6-d881-11e9-8a34-2a2ae2dbcce4','platform':'Google Analytics','category':'Analytics','cookie_name':'_gid','domain':'google-analytics.com (3rd party) or','description':'ID used to identify users for 24 hours after last activity','duration':'24 hours','data_controller':'Google','privacy_doc':'https://privacy.google.com/take-control.html','wildcard_match':'0'},{'id':'92250c0b-2cb3-4eea-8b38-f8cc19228ef0','platform':'LinkedIn','category':'Analytics','cookie_name':'AnalyticsSyncHistory','domain':'linkedin.com (3rd party)','description':'Used to store information about the time a sync with the lms_analytics cookie took place for users in the Designated Countries','duration':'30 days','data_controller':'LinkedIn','privacy_doc':'https://www.linkedin.com/legal/privacy-policy','wildcard_match':'0'},{'platform':'Google Analytics','category':'Analytics','cookie_name':'documentationConfig','description':'Used to collect information on how visitors interact with the documentation pages of a website.','duration':'30 minutes','data_controller':'Google','id':'2ad1eb11-2678-4a30-abcc-b1cf9f4b6ead'}],'description':'Analytics cookies are used to gather information on website usage, helping us understand visitor behavior. They track user interactions, providing insights that enable us to enhance the website\'s user experience and functionality. These cookies do not identify you personally but offer aggregated data to improve site performance.'},'marketing':{'data':[{'id':'02865dba-5da8-46ec-b100-50c1b8a1e913','platform':'Hubspot','category':'Marketing','cookie_name':'hubspotutk','domain':'hubspot.com','description':'This cookie keeps track of a visitor\'s identity. It is passed to HubSpot on form submission and used when deduplicating contacts.','duration':'13 months','data_controller':'HubSpot','privacy_doc':'https://legal.hubspot.com/privacy-policy','wildcard_match':'0'},{'id':'0641f061-2be6-4d26-adea-d8614c7f097b','platform':'Hubspot','category':'Marketing','cookie_name':'__hssc','domain':'hubspot.com','description':'This cookie keeps track of sessions.','duration':'30 minutes','data_controller':'HubSpot','privacy_doc':'https://legal.hubspot.com/privacy-policy','wildcard_match':'0'},{'id':'04f6c79c-87a2-420f-a341-15b806967c80','platform':'Hubspot','category':'Marketing','cookie_name':'__hssrc','domain':'hubspot.com','description':'Whenever HubSpot changes the session cookie, this cookie is also set to determine if the visitor has restarted their browser.','duration':'session','data_controller':'HubSpot','privacy_doc':'https://legal.hubspot.com/privacy-policy','wildcard_match':'0'},{'id':'a4a0bfbb-2fff-4352-a931-105381955855','platform':'Hubspot','category':'Marketing','cookie_name':'__hstc','domain':'hubspot.com','description':'The main cookie for tracking visitors.','duration':'13 months','data_controller':'HubSpot','privacy_doc':'https://legal.hubspot.com/privacy-policy','wildcard_match':'0'},{'id':'f0c95579-9131-4caf-8240-51eb01be6eb9','platform':'Google','category':'Marketing','cookie_name':'_gcl_au','domain':'','description':'Used by Google AdSense for experimenting with advertisement efficiency across websites using their services.','duration':'3 months','data_controller':'Google','privacy_doc':'https://privacy.google.com/take-control.html','wildcard_match':'0'},{'id':'ae06e8a9-ad4f-4bfa-96b9-0368a70528c0','platform':'LinkedIn','category':'Marketing','cookie_name':'li_sugr','domain':'','description':'Used to make a probabilistic match of a user\'s identity outside the Designated Countries','duration':'90 days','data_controller':'LinkedIn','privacy_doc':'https://www.linkedin.com/legal/privacy-policy','wildcard_match':'0'},{'id':'1b1067dd-9003-40f8-a2d6-c6ac72bb6779','platform':'LinkedIn','category':'Marketing','cookie_name':'lidc','domain':'linkedin.com (3rd party)','description':'Used by the social networking service, LinkedIn, for tracking the use of embedded services.','duration':'1 day','data_controller':'LinkedIn','privacy_doc':'https://www.linkedin.com/legal/privacy-policy','wildcard_match':'0'},{'id':'1874cfdd-0691-4ce0-a158-bc3c1605275e','platform':'LinkedIn','category':'Marketing','cookie_name':'UserMatchHistory','domain':'linkedin.com (3rd party)','description':'These cookies are set by LinkedIn for advertising purposes, including: tracking visitors so that more relevant ads can be presented, allowing users to use the \'Apply with LinkedIn\' or the \'Sign-in with LinkedIn\' functions, collecting information about how visitors use the site, etc.','duration':'session','data_controller':'LinkedIn','privacy_doc':'https://www.linkedin.com/legal/privacy-policy','wildcard_match':'0'},{'id':'657f80f4-7eb6-41c9-9bc7-7d2570a0887f','platform':'LinkedIn','category':'Marketing','cookie_name':'bcookie','domain':'linkedin.com (3rd party)','description':'Used by LinkedIn to track the use of embedded services.','duration':'1 year','data_controller':'LinkedIn','privacy_doc':'https://www.linkedin.com/legal/privacy-policy','wildcard_match':'0'},{'id':'002f276f-84c1-428a-bbe3-951a6cf56175','platform':'LinkedIn','category':'Marketing','cookie_name':'bscookie','domain':'linkedin.com (3rd party)','description':'Used by LinkedIn to track the use of embedded services.','duration':'1 year','data_controller':'LinkedIn','privacy_doc':'https://www.linkedin.com/legal/privacy-policy','wildcard_match':'0'},{'id':'87613af8-8486-47ef-93c9-b45c9c285106','platform':'Youtube','category':'Marketing','cookie_name':'VISITOR_INFO1_LIVE','domain':'youtube.com (3rd party)','description':'Tries to estimate the users\' bandwidth on pages with integrated YouTube videos. Also used for marketing','duration':'179 days','data_controller':'Google','privacy_doc':'https://privacy.google.com/take-control.html','wildcard_match':'0'},{'id':'2728a6ef-63ee-4f43-960c-b523f7e0286b','platform':'Youtube','category':'Marketing','cookie_name':'VISITOR_PRIVACY_METADATA','domain':'youtube.com (3rd party)','description':'Youtube visitor privacy metadata cookie','duration':'180 days','data_controller':'Google','privacy_doc':'https://privacy.google.com/take-control.html','wildcard_match':'0'},{'id':'256c8986-d881-11e9-8a34-2a2ae2dbcce4','platform':'DoubleClick/Google Marketing','category':'Marketing','cookie_name':'IDE','domain':'doubleclick.net (3rd party)','description':'This cookie is used for targeting, analyzing and optimisation of ad campaigns in DoubleClick/Google Marketing Suite ','duration':'2 years','data_controller':'Google','privacy_doc':'https://privacy.google.com/take-control.html','wildcard_match':'0'}],'description':'Our advertising partners deploy these cookies to tailor advertising to your interests, based on your browsing behavior and preferences. They track your online activity to build a profile for customized advertising, ensuring the ads you encounter on other sites are aligned with your interests.'}}
...
function submitConsent(agreedCategories) {
    ...
    fetch(`http:localhost:3000/ext/cookie-banner/${orgId}/${bannerId}`, {
        method: 'POST',
        headers: {
